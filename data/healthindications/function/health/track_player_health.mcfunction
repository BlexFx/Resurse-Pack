...
execute if score #healthindications.option.health_bar.toggle healthindications.data matches 1 if score #healthindications.option.health_bar.affect_players healthindications.data matches 1 if score #healthindications.option.health_bar.custom_texture healthindications.data matches 1 if score #healthindications.option.health_bar.status_effects healthindications.data matches 1 if entity @s[tag=!global.ignore,tag=!healthindications.ignore,tag=!healthindications.no_status_effects] run function healthindications:status_effect/check_status_effect

#update health related indications
execute if score @s healthindications.health_bar.update matches 1 run function healthindications:health/player_health_update
